...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendNote = channel.unary_unary(
                ...
                _registered_method=True)
        self.printDebugInformation = channel.unary_unary(
                '/ChatServer/printDebugInformation',
                request_serializer=chat__pb2.Empty.SerializeToString,
                response_deserializer=chat__pb2.Empty.FromString,
                _registered_method=True)
...
def add_ChatServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'printDebugInformation': grpc.unary_unary_rpc_method_handler(
                    servicer.printDebugInformation,
                    request_deserializer=chat__pb2.Empty.FromString,
                    response_serializer=chat__pb2.Empty.SerializeToString,
            ),
    }
    ...
    server.add_registered_method_handlers('ChatServer', rpc_method_handlers)
...
class ChatServer(object):
    ...
    @staticmethod
    def printDebugInformation(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
